...
exports.fdaRouter = void 0;
const express_1 = require("express");
exports.fdaRouter = (0, express_1.Router)();
// ── ClinicalTrials.gov v2 API ──
exports.fdaRouter.post('/api/enrich/clinicaltrials', async (req, res) => {
    ...
    try {
        ...
        const studies = (data.studies || []).map((s) => {
            ...
            const interventions = (proto.armsInterventionsModule?.interventions || []).map((iv) => ({ type: iv.type, name: iv.name }));
            return {
                nctId: id.nctId,
                title: id.briefTitle,
        ...
        const phaseIII = studies.filter((s) => s.phase?.includes('3') || s.phase?.includes('III'));
...
// ── FDA openFDA API ──
exports.fdaRouter.post('/api/enrich/fda', async (req, res) => {
...
async function fetchFdaDrugs(companyName, field) {
...
async function fetchFdaLabels(companyName) {
    const encoded = encodeURIComponent(`"${companyName}"`);
