...
const BUILT_IN_AGENTS: AgentDef[] = [
  ...
  },
  {
    ...
    tools: [
      ...
      'factory_get_cm21_orders', 'factory_get_blocked_orders_count', 'factory_get_shift_schedule',
      ...
      'factory_get_oee_summary', 'factory_get_machine_oee',
      'factory_get_production_history', 'factory_get_scrap_history',
    ],
    difficulty: 'Beginner',
    icon: '⚡',
    featured: true,
