...
module.exports = function(RED) {
  function OsfMcpErpNode(config) {
    ...
    node.on('input', function(msg, send, done) {
      ...
      // Template replacement in arguments using msg.payload context
      ...
      svc.callMcpTool(toolName, args).then(function(result) {
        msg.payload = result;
        msg._source = { type: 'osf-mcp-erp', id: node.id, name: node.name || toolName };
  ...
  RED.nodes.registerType('osf-mcp-erp', OsfMcpErpNode);
};
