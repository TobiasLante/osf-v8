...
module.exports = function(RED) {
  function OsfMcpFertigungNode(config) {
    ...
    node.on('input', function(msg, send, done) {
      ...
      svc.callMcpTool(toolName, args).then(function(result) {
        msg.payload = result;
        msg._source = { type: 'osf-mcp-fertigung', id: node.id, name: node.name || toolName };
  ...
  RED.nodes.registerType('osf-mcp-fertigung', OsfMcpFertigungNode);
};
