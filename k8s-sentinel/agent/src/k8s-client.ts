...
export interface K8sClient {
  fetchClusterSnapshot(): Promise<ClusterSnapshot>;
  getPodLogs(namespace: string, podName: string, lines?: number): Promise<string>;
  deletePod(namespace: string, name: string): Promise<void>;
  deleteJob(namespace: string, name: string): Promise<void>;
  rollbackDeployment(namespace: string, name: string): Promise<void>;
  patchResourceLimits(namespace: string, deploymentName: string, containerName: string, memoryLimit: string): Promise<void>;
}

export function createK8sClient(kubeconfigPath: string, context: string): K8sClient {
  ...
  async function fetchClusterSnapshot(): Promise<ClusterSnapshot> {
  ...
  async function getPodLogs(namespace: string, podName: string, lines = 100): Promise<string> {
    try {
  ...
  async function patchResourceLimits(namespace: string, deploymentName: string, containerName: string, memoryLimit: string): Promise<void> {
