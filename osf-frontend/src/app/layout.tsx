...
export const metadata: Metadata = {
  ...
  description:
    "Build manufacturing AI agents in minutes. 118 MCP tools, live factory data, visual flows, and gamified challenges — all free.",
  keywords: [
    "AI agents",
    "manufacturing",
    "MCP",
  ...
  openGraph: {
    title: "OpenShopFloor — Free Manufacturing AI Playground",
    description:
      "Build manufacturing AI agents in minutes. 118 MCP tools, live factory data, visual flows, and challenges — all free.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "OpenShopFloor — AI agent flow editor with 118 MCP tools for manufacturing",
      },
    ],
  },
  twitter: {
    ...
    title: "OpenShopFloor — Free Manufacturing AI Playground",
    description:
      "118 MCP tools for manufacturing AI. Build, test, and deploy AI agents with real factory data. Free.",
              ...
              "@graph": [
                {
                  ...
                  "url": "https://openshopfloor.zeroguess.ai",
                  "description":
                    "Free Manufacturing AI Playground. 118 MCP tools, visual flow editor, AI agent builder, gamified challenges.",
                },
                {
                  ...
                  "url": "https://openshopfloor.zeroguess.ai",
                  "description":
                    "Free Manufacturing AI Playground with 118 MCP tools. Build, test, and deploy manufacturing AI agents with real ERP, OEE, QMS, and WMS data.",
                  "offers": {
                    "@type": "Offer",
                    "price": "0",
                    "priceCurrency": "USD",
                  ...
                  "featureList": [
                    "118 MCP tools for manufacturing",
